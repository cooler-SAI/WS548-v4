...
class WorldObject : public Object, public WorldLocation
{
    ...
    public:
        ...
        // Use only if you are sure both objects are placed on the same map.
        ...
        void BuildMonsterChat(WorldPacket* data, uint8 msgtype, char const* text, uint32 language, char const* name, uint64 TargetGuid);
