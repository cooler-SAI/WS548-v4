...
enum AuraType
{
    ...
    SPELL_AURA_46                                           = 46,  // Ignore all Gear test spells. Now SPELL_AURA_TRANSFORM? Check 48050, 69715. NYI.
    ...
    SPELL_AURA_164                                          = 164, // SPELL_AURA_DROWNING? Check 110317. NYI.
    ...
    SPELL_AURA_214                                          = 214, // SPELL_AURA_TAMED_PET_PASSIVE. Check 20782. NYI.
    ...
    SPELL_AURA_222                                          = 222, // SPELL_AURA_JUMP_TO_ALLY. Check 44586, 93092. NYI.
    ...
    SPELL_AURA_230                                          = 230, // SPELL_AURA_MOD_MAX_HEALTH. Check 45517, 78823. NYI.
    ...
    SPELL_AURA_264                                          = 264, // Check 19263, 89751. NYI.
    SPELL_AURA_265                                          = 265,
    SPELL_AURA_266                                          = 266,
    ...
    SPELL_AURA_289                                          = 289, // Check 82890. NYI.
    ...
    SPELL_AURA_311                                          = 311,  // Check 99247, 99561.
    ...
    SPELL_AURA_321                                          = 321,  // Check 45257, 93958.
    ...
    SPELL_AURA_359                                          = 359,  // Mods healing done on targets having an aura. Check 99263. NYI.
    ...
    SPELL_AURA_362                                          = 362,  // Some Persistent Area Aura, check 143400.
    ...
    SPELL_AURA_367                                          = 367,  // SPELL_AURA_OVERRIDE_AUTO_ATTACK. Triggers MH spell, applies aura to trigger OH spell at the same time (miscvalue). Check 114051, 137586. NYI.
    ...
    SPELL_AURA_387                                          = 387,  // SPELL_AURA_MOD_DISCOUNT_USE_TRANSMOG. 5.0.5. NYI.
    ...
    SPELL_AURA_394                                          = 394,  // Asks client a question, requires action ok / cancel. Box?. Check 142162, 150145, 161736. 5.0.5. NYI.
    SPELL_AURA_395                                          = 395,  // SPELL_AURA_CREATE_AREATRIGGER. Check 126296. 5.0.5. NYI.
    SPELL_AURA_396                                          = 396,  // SPELL_AURA_PERIODICALLY_TRIGGER_SPELL. Check 126419. 5.0.5. NYI.
    SPELL_AURA_397                                          = 397,  // PvP flag carrier aura to drop it when dies? Check 23335, 23333. 5.0.5. NYI.
    SPELL_AURA_398                                          = 398,  // PvP flag carrier aura to drop it when dies? Check 166579, 176722. 5.0.5. NYI.
    ...
    SPELL_AURA_406                                          = 406,  // Weird one. May be related to jumping. Check 140858. 5.0.5. NYI.
    SPELL_AURA_MOD_FEAR_2                                   = 407,  // SPELL_AURA_MOD_FEAR_2
    SPELL_AURA_408                                          = 408,  // Related to procs. Check 115867, 131116. 5.0.5. NYI.
    SPELL_AURA_ALLOW_TURN_WHILE_FALLING                     = 409,  // SPELL_AURA_ALLOW_TURN_WHILE_FALLING
    SPELL_AURA_410                                          = 410,  // Check 57902. 5.0.5. NYI.
    ...
    SPELL_AURA_413                                          = 413,  // SPELL_AURA_DEFLECT_RANGED_ATTACKS, check 137531. 5.0.5. NYI.
    SPELL_AURA_414                                          = 414,  // SPELL_AURA_DEFLECT_FRONT_RANGED_ATTACKS, check 147689. 5.0.5. NYI.
    SPELL_AURA_415                                          = 415,  // Related to phasing? Check 123316. 5.0.5. NYI.
    SPELL_AURA_SANCTITY_OF_BATTLE                           = 416,  // SPELL_AURA_SANCTITY_OF_BATTLE
    SPELL_AURA_417                                          = 417,  // SPELL_AURA_REDUCE_GLOBAL_COOLDOWN, affected by Haste, check 158836, 154555. 5.0.5. NYI.
    SPELL_AURA_418                                          = 418,  // SPELL_AURA_MOD_INCREASE_POWER. 5.0.5. NYI.
    SPELL_AURA_MOD_INCREASE_ENERGY_PERCENT_2                = 419,  // SPELL_AURA_MOD_INCREASE_ENERGY_PERCENT_2. Increases any base power %.
    ...
    SPELL_AURA_432                                          = 432,  // 5.4.0 unk aura (NYI) see 91318
