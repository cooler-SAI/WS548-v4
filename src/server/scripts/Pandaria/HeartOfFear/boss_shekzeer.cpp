...
enum Spells
{
	SPELL_EARTHQUAKE = 124849,
	SPELL_SUNDER_ARMOR = 123788,
	SPELL_CHAIN_LIGHTNING = 123735,
	SPELL_OVERRUN = 123707,
	SPELL_ENRAGE = 125464,
	SPELL_MARK_DEATH = 124862,
	SPELL_AURA_DEATH = 122863
};
...
public:
	...
	struct boss_shekzeerAI : public ScriptedAI
	{
		boss_shekzeerAI(Creature* creature) : ScriptedAI(creature)
		{
			Initialize();
		}
